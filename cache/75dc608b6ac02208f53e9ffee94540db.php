	...
	<div class="container pt">
		...
		<div class="row mt centered">	
			<div class="col-lg-8 col-lg-offset-2">
				<form action="index.php?c=upload&a=dophoto" method="post" enctype="multipart/form-data">
            <table width="800"  class="liubo">
              <tr height='40'>
                <td width="100" align="right"><span>用户名:</span></td>
                <td width="20"></td>
                <td width="200" align="left">
                  <input type="text" name="username" value="<?php echo $ures[0]['username']; ?>" />
                </td>
              </tr>
              <tr height='40'>
                ...
                <td></td>
                <td align="left">
                  <input type="number" name="age" value="<?php echo $ures[0]['age']; ?>" />
                </td>
              </tr>
              <tr height='100'>
                ...
                <td align="left" valign="bottom">
                  <img src="<?php echo $ures[0]['photo']; ?>" alt="" height="90" width="120" style="border-radius:5px;">  <b style="font-size: 12px;color: red;">请选择一张宽大于高的照片</b>
                </td>
              </tr>
              <tr height='40'>
                <td></td>
