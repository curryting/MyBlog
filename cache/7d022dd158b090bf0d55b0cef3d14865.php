	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<p><img src="public/img/curry.jpg" width="70px" height="50px" style="border-radius: 5px;">&nbsp;&nbsp;&nbsp;<ba style='color: #1abc9c;font-weight: bold;'>Forever</ba></p>
					<p>
						<bd><?php echo $time=date('Y-m-d H:i:m',$val['date']); ?></bd>
						&nbsp;&nbsp;浏览：<span style="color: red;"><?php echo $val['hits']; ?></span>
						评论：<span style="color: red"><?php echo $val['replycount']; ?></span>
						&nbsp;&nbsp;&nbsp;&nbsp;标签：<?php echo $val['tag']; ?>
					</p>
					...
					<p><a href="index.php?a=blog01&id=<?php echo $val['id']; ?>">查看更多...</a></p>
				</div>
