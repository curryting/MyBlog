	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<p>
						<bd><?php echo $time=date('Y-m-d, H:i:s',$sres[0]['date']); ?></bd>
						&nbsp;&nbsp;浏览：<span style="color: red;"><?php echo $sres[0]['hits']; ?></span>
						&nbsp;&nbsp;&nbsp;&nbsp;标签：<?php echo $sres[0]['tag']; ?>
					</p>
					
						<h4><?php echo $sres[0]['title']; ?></h4>
						<!--
					...
					<p>
						...
						<!--【注2】存放markdown格式的时候，如果有特殊字符，可以使用htmlentities和addcslashs进行转化-->
							<textarea style="display:none;" name="test-editormd-markdown-doc"><?php echo $sres[0]['content']; ?>
					        </textarea>
						</div>
					</p>
					<br>
					<p><bt>TAGS: <a href="#"><?php echo $sres[0]['tag']; ?></a></bt></p>
						
					<hr>
					<p><a href="index.php?a=share_list&cid=<?php echo $cid; ?>"> 返回</a></p>

					<!--评论开始-->
						<div id="respond-post-77" class="respond">
					       <div class="comments-content">
					          <!-- Comment Form -->
					          <form method="post" action="index.php?c=content&a=docomment&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" id="comment-form" class="comment-form" role="form">
					...
					<span style="display: block;float: right;">共有<span style="color: red"><?php echo $sres[0]['replycount']; ?></span>条记录</span>
				</h5>
					<?php if (!empty($cres)): ?>
					...
					<!--判断该留言的uid是否是一个uniqid生成的id，如果不是,则找到用户对应的头像-->
						...
						<div style="float: left;width: 90%">
							...
							<?php endforeach; ?>
							<?php endif; ?>
							<form class="form" action="index.php?c=content&a=docomment&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&hid=<?php echo $val['id']; ?>" method="post">
					...
					<!--遍历评论结束-->
					<div>
					<a href="index.php?a=content&page=<?php echo $url['first']; ?>" style="font-size: 18px;">首页</a>&nbsp;
					<a href="index.php?a=content&page=<?php echo $url['prev']; ?>" style="font-size: 18px;">上一页</a>&nbsp;
					<a href="index.php?a=content" style="font-size: 18px;"></a>
					<a href="index.php?a=content&page=<?php echo $url['next']; ?>" style="font-size: 18px;">下一页</a>&nbsp;
					<a href="index.php?a=content&page=<?php echo $url['end']; ?>" style="font-size: 18px;">尾页</a>
					</div>
